...
hojo.declare("icallcenter.SoftphoneBar", null, {
	...
	_peerHour: "0",
			...
			//sip方式的toolbar状态   // Idle 空闲   Rest小休  Busy忙碌   Eat用餐  
	sip_stInvalid: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	sip_stBusy: ["DialEnable", "HangupEnable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],
	sip_stRest: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestEnable", "BusyDisable", "EatDisable"],
	sip_stDialing: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallEnable", "TransferEnable","ConsultEnable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	sip_stDialTalking: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	sip_stHold:["DialEnable", "HangupEnable", "HoldGetEnable","ThreeWayCallDisable", "TransferDisable","ConsultDisable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	sip_stAbate: ["DialDisable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	sip_stInnerDialing: ["DialDisable", "HangupEnable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable","ConsultDisable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	...
	sip_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],

	
	//gateway方式的toolbar状态
	gateway_stInvalid: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleEnable", "RestDisable", "BusyDisable", "EatDisable"],
	gateway_stBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],
	gateway_stRest: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestEnable", "BusyDisable", "EatDisable"],
	gateway_stDialing: ["DialDisable", "HangupEnable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable","ConsultDisable"],
	gateway_stDialTalking: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	...
	gateway_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],

	
	//Local方式的toolbar状态
	Local_stInvalid: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleEnable", "RestDisable", "BusyDisable", "EatEnable"],
	Local_stBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],
	Local_stRest: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestEnable", "BusyDisable", "EatEnable"],
	Local_stDialing: ["DialDisable", "HangupEnable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable","ConsultDisable"],
	Local_stDialTalking: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "IdleEnable", "RestEnable", "BusyEnable", "EatEnable"],
	...
	Local_stSystemBusy: ["DialEnable", "HangupDisable", "HoldDisable", "ThreeWayCallDisable", "TransferDisable", "ConsultDisable", "IdleDisable", "RestDisable", "BusyEnable", "EatEnable"],
	...
	onCallToolBarStateChanged: function(state) {
		//toolbar status
		this.onChangeState(state);
		var color = this._callStateColor[this._phone._peerState._curPeerStateKey];
		//peer status
		...
		//hid peer status
		var peerStatus = this._srcNodePeerStateRef;
		if(peerStatus == null) {
			return;
		}
...
//	var gpsinfoid = localStorage.getItem("gpsinfoids")
//		console.log(gpsinfoid);

    dialout: function (phoneNum,gpsInfoId) {
    	var timestamp=new Date().getTime()
        if (/^\d+$/.test(phoneNum)) {
            this._phone.dialout(phoneNum,gpsInfoId+"."+timestamp);
            return true;
        } else {
